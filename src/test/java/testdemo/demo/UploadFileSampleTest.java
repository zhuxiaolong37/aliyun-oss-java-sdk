...
public class UploadFileSampleTest {
    ...
    // 填写Bucket名称。
    String bucketName = "oss-other-a2-user";
    String objectName = "recode-test中文.txt";
    String prefix = "a";
...
//            ossClient.deleteObject(bucketName, key);
    ...
    public void testUploadFileSequential() throws Throwable {
        ...
        String testBucketName = this.bucketName + "-upload-sequential";
...
//            ossClient.deleteObject(bucketName, key);
    ...
    public void testUploadRetryWithProgress() {
            ...
            Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        uploadFileRequest.withProgressListener(new UploadFileSampleTest.UploadFileProgressListener(finalFile.length(), false, 200 * 1024));
        ...
        try {
            ...
            uploadFileRequest.withProgressListener(new UploadFileSampleTest.UploadFileProgressListener(file.length(), true, 200 * 1024));
            ossClient.uploadFile(uploadFileRequest);
        }  catch (Throwable e) {
            e.printStackTrace();
            Assert.fail(e.getMessage());
